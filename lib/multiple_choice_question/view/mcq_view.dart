...
import 'package:winning_streak_app/multiple_choice_question/cubit/question_cubit.dart';

import 'package:winning_streak_app/multiple_choice_question/view/choice_tile.dart';
import 'package:winning_streak_app/multiple_choice_question/view/question_initial_view.dart';
          ...
          if(!streakEnded) {
            ...
            //if the user is signed in submit the score to the global db
             if (context.read<AuthorizationCubit>().state
              ...
              var auth = context.read<AuthorizationCubit>().state
                  as AuthorizationSignedIn;
              context.read<GlobalHighScoreCubit>().submitPossibleHighScore(
                  auth.initials, streak, DateTime.now());
            }
